# Codex Execution Profile -- filesystem-path-rationalization

Codex runtime wrapper for `filesystem-path-rationalization`.

## Steps

1. Read `../../skills/filesystem-path-rationalization/SKILL.md` and identify the exact task path, trigger, or command family that applies.
