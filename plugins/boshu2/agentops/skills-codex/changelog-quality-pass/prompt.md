# Codex Execution Profile -- changelog-quality-pass

Codex runtime wrapper for `changelog-quality-pass`.

## Steps

1. Read `../../skills/changelog-quality-pass/SKILL.md` and identify the exact task path, trigger, or command family that applies.
