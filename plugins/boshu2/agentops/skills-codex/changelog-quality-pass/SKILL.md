...
Codex-native entry point for the `changelog-quality-pass` operator skill.

The AgentOps source skill `../../skills/changelog-quality-pass/SKILL.md` is the source of truth
