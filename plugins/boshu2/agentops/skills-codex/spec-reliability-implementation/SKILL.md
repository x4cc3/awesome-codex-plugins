...
Codex-native entry point for the `spec-reliability-implementation` operator skill.

The AgentOps source skill `../../skills/spec-reliability-implementation/SKILL.md` is the source of truth
