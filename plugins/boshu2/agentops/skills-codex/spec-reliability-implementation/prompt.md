# Codex Execution Profile -- spec-reliability-implementation

Codex runtime wrapper for `spec-reliability-implementation`.

## Steps

1. Read `../../skills/spec-reliability-implementation/SKILL.md` and identify the exact task path, trigger, or command family that applies.
