# Codex Execution Profile -- dependency-update-safety

Codex runtime wrapper for `dependency-update-safety`.

## Steps

1. Read `../../skills/dependency-update-safety/SKILL.md` and identify the exact task path, trigger, or command family that applies.
