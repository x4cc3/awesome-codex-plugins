# Codex Execution Profile -- ru-multi-repo-workflow
...
1. Read `../../skills/ru-multi-repo-workflow/SKILL.md` and identify the exact task path, trigger, or command family that applies.
