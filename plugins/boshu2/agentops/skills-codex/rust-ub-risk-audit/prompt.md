# Codex Execution Profile -- rust-ub-risk-audit

Codex runtime wrapper for `rust-ub-risk-audit`.

## Steps

1. Read `../../skills/rust-ub-risk-audit/SKILL.md` and identify the exact task path, trigger, or command family that applies.
