# Codex Execution Profile -- production-placeholder-audit

Codex runtime wrapper for `production-placeholder-audit`.

## Steps

1. Read `../../skills/production-placeholder-audit/SKILL.md` and identify the exact task path, trigger, or command family that applies.
