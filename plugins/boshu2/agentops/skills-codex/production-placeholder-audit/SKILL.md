...
Codex-native entry point for the `production-placeholder-audit` operator skill.

The AgentOps source skill `../../skills/production-placeholder-audit/SKILL.md` is the source of truth
