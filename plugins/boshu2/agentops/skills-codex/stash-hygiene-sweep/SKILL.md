...
Codex-native entry point for the `stash-hygiene-sweep` operator skill.

The AgentOps source skill `../../skills/stash-hygiene-sweep/SKILL.md` is the source of truth
