# Codex Execution Profile -- stash-hygiene-sweep

Codex runtime wrapper for `stash-hygiene-sweep`.

## Steps

1. Read `../../skills/stash-hygiene-sweep/SKILL.md` and identify the exact task path, trigger, or command family that applies.
