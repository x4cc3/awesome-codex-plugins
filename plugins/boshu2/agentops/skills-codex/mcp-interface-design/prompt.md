# Codex Execution Profile -- mcp-interface-design

Codex runtime wrapper for `mcp-interface-design`.

## Steps

1. Read `../../skills/mcp-interface-design/SKILL.md` and identify the exact task path, trigger, or command family that applies.
