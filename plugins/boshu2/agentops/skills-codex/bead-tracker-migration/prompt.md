# Codex Execution Profile -- bead-tracker-migration

Codex runtime wrapper for `bead-tracker-migration`.

## Steps

1. Read `../../skills/bead-tracker-migration/SKILL.md` and identify the exact task path, trigger, or command family that applies.
