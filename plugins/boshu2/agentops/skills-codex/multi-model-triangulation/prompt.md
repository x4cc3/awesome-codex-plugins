# Codex Execution Profile -- multi-model-triangulation
...
1. Read `../../skills/multi-model-triangulation/SKILL.md` and identify the exact task path, trigger, or command family that applies.
