# Codex Execution Profile -- system-performance-remediation
...
1. Read `../../skills/system-performance-remediation/SKILL.md` and identify the exact task path, trigger, or command family that applies.
