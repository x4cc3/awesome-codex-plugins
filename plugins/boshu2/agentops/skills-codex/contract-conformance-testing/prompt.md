# Codex Execution Profile -- contract-conformance-testing

Codex runtime wrapper for `contract-conformance-testing`.

## Steps

1. Read `../../skills/contract-conformance-testing/SKILL.md` and identify the exact task path, trigger, or command family that applies.
