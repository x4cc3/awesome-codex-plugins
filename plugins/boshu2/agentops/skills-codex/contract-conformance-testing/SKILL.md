...
Codex-native entry point for the `contract-conformance-testing` operator skill.

The AgentOps source skill `../../skills/contract-conformance-testing/SKILL.md` is the source of truth
