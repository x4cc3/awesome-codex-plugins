# Codex Execution Profile -- golden-artifact-testing

Codex runtime wrapper for `golden-artifact-testing`.

## Steps

1. Read `../../skills/golden-artifact-testing/SKILL.md` and identify the exact task path, trigger, or command family that applies.
