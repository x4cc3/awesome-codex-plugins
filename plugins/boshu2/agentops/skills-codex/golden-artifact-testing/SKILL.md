...
Codex-native entry point for the `golden-artifact-testing` operator skill.

The AgentOps source skill `../../skills/golden-artifact-testing/SKILL.md` is the source of truth
