# Codex Execution Profile -- fuzz-test-design

Codex runtime wrapper for `fuzz-test-design`.

## Steps

1. Read `../../skills/fuzz-test-design/SKILL.md` and identify the exact task path, trigger, or command family that applies.
