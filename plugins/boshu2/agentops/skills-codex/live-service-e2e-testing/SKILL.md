...
Codex-native entry point for the `live-service-e2e-testing` operator skill.

The AgentOps source skill `../../skills/live-service-e2e-testing/SKILL.md` is the source of truth
