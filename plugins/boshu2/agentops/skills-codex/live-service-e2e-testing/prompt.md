# Codex Execution Profile -- live-service-e2e-testing

Codex runtime wrapper for `live-service-e2e-testing`.

## Steps

1. Read `../../skills/live-service-e2e-testing/SKILL.md` and identify the exact task path, trigger, or command family that applies.
