# Codex Execution Profile -- metamorphic-test-design

Codex runtime wrapper for `metamorphic-test-design`.

## Steps

1. Read `../../skills/metamorphic-test-design/SKILL.md` and identify the exact task path, trigger, or command family that applies.
