...
Codex-native entry point for the `metamorphic-test-design` operator skill.

The AgentOps source skill `../../skills/metamorphic-test-design/SKILL.md` is the source of truth
