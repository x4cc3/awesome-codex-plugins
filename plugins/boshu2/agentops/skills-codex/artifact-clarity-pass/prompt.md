# Codex Execution Profile -- artifact-clarity-pass

Codex runtime wrapper for `artifact-clarity-pass`.

## Steps

1. Read `../../skills/artifact-clarity-pass/SKILL.md` and identify the exact task path, trigger, or command family that applies.
