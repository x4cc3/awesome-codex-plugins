...
Codex-native entry point for the `project-readme-craft` operator skill.

The AgentOps source skill `../../skills/project-readme-craft/SKILL.md` is the source of truth
