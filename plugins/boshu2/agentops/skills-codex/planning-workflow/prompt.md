# Codex Execution Profile -- planning-workflow
...
1. Read `../../skills/planning-workflow/SKILL.md` and identify the exact task path, trigger, or command family that applies.
