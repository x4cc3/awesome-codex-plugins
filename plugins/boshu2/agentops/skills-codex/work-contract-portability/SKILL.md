...
Codex-native entry point for the `work-contract-portability` operator skill.

The AgentOps source skill `../../skills/work-contract-portability/SKILL.md` is the source of truth
