# Codex Execution Profile -- work-contract-portability

Codex runtime wrapper for `work-contract-portability`.

## Steps

1. Read `../../skills/work-contract-portability/SKILL.md` and identify the exact task path, trigger, or command family that applies.
