# Codex Execution Profile -- behavior-preserving-simplification

Codex runtime wrapper for `behavior-preserving-simplification`.

## Steps

1. Read `../../skills/behavior-preserving-simplification/SKILL.md` and identify the exact task path, trigger, or command family that applies.
