...
Codex-native entry point for the `worktree-branch-rationalization` operator skill.

The AgentOps source skill `../../skills/worktree-branch-rationalization/SKILL.md` is the source of truth
