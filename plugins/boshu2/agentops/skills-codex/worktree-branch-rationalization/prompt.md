# Codex Execution Profile -- worktree-branch-rationalization

Codex runtime wrapper for `worktree-branch-rationalization`.

## Steps

1. Read `../../skills/worktree-branch-rationalization/SKILL.md` and identify the exact task path, trigger, or command family that applies.
