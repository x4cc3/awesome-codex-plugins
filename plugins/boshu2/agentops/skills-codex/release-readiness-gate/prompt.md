# Codex Execution Profile -- release-readiness-gate

Codex runtime wrapper for `release-readiness-gate`.

## Steps

1. Read `../../skills/release-readiness-gate/SKILL.md` and identify the exact task path, trigger, or command family that applies.
