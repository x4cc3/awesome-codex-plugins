# Codex Execution Profile -- cli-doctoring-workflow

Codex runtime wrapper for `cli-doctoring-workflow`.

## Steps

1. Read `../../skills/cli-doctoring-workflow/SKILL.md` and identify the exact task path, trigger, or command family that applies.
