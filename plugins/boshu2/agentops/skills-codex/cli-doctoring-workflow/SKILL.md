...
Codex-native entry point for the `cli-doctoring-workflow` operator skill.

The AgentOps source skill `../../skills/cli-doctoring-workflow/SKILL.md` is the source of truth
