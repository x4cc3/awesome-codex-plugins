...
Codex-native entry point for the `implementation-pattern-mining` operator skill.

The AgentOps source skill `../../skills/implementation-pattern-mining/SKILL.md` is the source of truth
