# Codex Execution Profile -- implementation-pattern-mining

Codex runtime wrapper for `implementation-pattern-mining`.

## Steps

1. Read `../../skills/implementation-pattern-mining/SKILL.md` and identify the exact task path, trigger, or command family that applies.
