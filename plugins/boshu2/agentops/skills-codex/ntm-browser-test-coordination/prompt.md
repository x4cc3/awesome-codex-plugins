# Codex Execution Profile -- ntm-browser-test-coordination

Codex runtime wrapper for `ntm-browser-test-coordination`.

## Steps

1. Read `../../skills/ntm-browser-test-coordination/SKILL.md` and identify the exact task path, trigger, or command family that applies.
