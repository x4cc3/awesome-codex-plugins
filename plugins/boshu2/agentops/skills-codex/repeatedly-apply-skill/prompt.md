# Codex Execution Profile -- repeatedly-apply-skill
...
1. Read `../../skills/repeatedly-apply-skill/SKILL.md` and identify the exact task path, trigger, or command family that applies.
