# Codex Execution Profile -- automation-loop-hardening

Codex runtime wrapper for `automation-loop-hardening`.

## Steps

1. Read `../../skills/automation-loop-hardening/SKILL.md` and identify the exact task path, trigger, or command family that applies.
