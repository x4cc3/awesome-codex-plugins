# Codex Execution Profile -- layered-defect-hunt

Codex runtime wrapper for `layered-defect-hunt`.

## Steps

1. Read `../../skills/layered-defect-hunt/SKILL.md` and identify the exact task path, trigger, or command family that applies.
