...
Codex-native entry point for the `layered-defect-hunt` operator skill.

The AgentOps source skill `../../skills/layered-defect-hunt/SKILL.md` is the source of truth
