...
Codex-native entry point for the `rust-unsafe-boundary-audit` operator skill.

The AgentOps source skill `../../skills/rust-unsafe-boundary-audit/SKILL.md` is the source of truth
