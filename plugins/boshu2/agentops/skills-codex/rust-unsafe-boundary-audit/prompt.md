# Codex Execution Profile -- rust-unsafe-boundary-audit

Codex runtime wrapper for `rust-unsafe-boundary-audit`.

## Steps

1. Read `../../skills/rust-unsafe-boundary-audit/SKILL.md` and identify the exact task path, trigger, or command family that applies.
