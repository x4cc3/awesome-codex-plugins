# Codex Execution Profile -- expertise-to-procedure

Codex runtime wrapper for `expertise-to-procedure`.

## Steps

1. Read `../../skills/expertise-to-procedure/SKILL.md` and identify the exact task path, trigger, or command family that applies.
