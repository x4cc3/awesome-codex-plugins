...
Codex-native entry point for the `expertise-to-procedure` operator skill.

The AgentOps source skill `../../skills/expertise-to-procedure/SKILL.md` is the source of truth
