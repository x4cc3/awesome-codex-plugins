# Codex Execution Profile -- bead-completion-audit

Codex runtime wrapper for `bead-completion-audit`.

## Steps

1. Read `../../skills/bead-completion-audit/SKILL.md` and identify the exact task path, trigger, or command family that applies.
