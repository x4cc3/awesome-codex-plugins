...
Codex-native entry point for the `bead-completion-audit` operator skill.

The AgentOps source skill `../../skills/bead-completion-audit/SKILL.md` is the source of truth
