# Codex Execution Profile -- measured-performance-optimization

Codex runtime wrapper for `measured-performance-optimization`.

## Steps

1. Read `../../skills/measured-performance-optimization/SKILL.md` and identify the exact task path, trigger, or command family that applies.
