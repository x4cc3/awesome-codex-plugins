...
Codex-native entry point for the `measured-performance-optimization` operator skill.

The AgentOps source skill `../../skills/measured-performance-optimization/SKILL.md` is the source of truth
