# Codex Execution Profile -- codebase-risk-audit

Codex runtime wrapper for `codebase-risk-audit`.

## Steps

1. Read `../../skills/codebase-risk-audit/SKILL.md` and identify the exact task path, trigger, or command family that applies.
