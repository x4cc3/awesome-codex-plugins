# Codex Execution Profile -- rust-search-integration

Codex runtime wrapper for `rust-search-integration`.

## Steps

1. Read `../../skills/rust-search-integration/SKILL.md` and identify the exact task path, trigger, or command family that applies.
