...
Codex-native entry point for the `rust-search-integration` operator skill.

The AgentOps source skill `../../skills/rust-search-integration/SKILL.md` is the source of truth
