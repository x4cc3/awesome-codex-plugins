# Codex Execution Profile -- research-software
...
1. Read `../../skills/research-software/SKILL.md` and identify the exact task path, trigger, or command family that applies.
