# Codex Execution Profile -- installer-quality-audit

Codex runtime wrapper for `installer-quality-audit`.

## Steps

1. Read `../../skills/installer-quality-audit/SKILL.md` and identify the exact task path, trigger, or command family that applies.
