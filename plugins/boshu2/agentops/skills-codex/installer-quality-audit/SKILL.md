...
Codex-native entry point for the `installer-quality-audit` operator skill.

The AgentOps source skill `../../skills/installer-quality-audit/SKILL.md` is the source of truth
