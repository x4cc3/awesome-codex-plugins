# Codex Execution Profile -- external-search-triage

Codex runtime wrapper for `external-search-triage`.

## Steps

1. Read `../../skills/external-search-triage/SKILL.md` and identify the exact task path, trigger, or command family that applies.
