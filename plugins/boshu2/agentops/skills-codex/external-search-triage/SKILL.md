...
Codex-native entry point for the `external-search-triage` operator skill.

The AgentOps source skill `../../skills/external-search-triage/SKILL.md` is the source of truth
