...
Codex-native entry point for the `legacy-codebase-recon` operator skill.

The AgentOps source skill `../../skills/legacy-codebase-recon/SKILL.md` is the source of truth
