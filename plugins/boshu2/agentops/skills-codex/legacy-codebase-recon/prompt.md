# Codex Execution Profile -- legacy-codebase-recon

Codex runtime wrapper for `legacy-codebase-recon`.

## Steps

1. Read `../../skills/legacy-codebase-recon/SKILL.md` and identify the exact task path, trigger, or command family that applies.
