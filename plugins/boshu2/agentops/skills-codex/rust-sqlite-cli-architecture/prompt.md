# Codex Execution Profile -- rust-sqlite-cli-architecture

Codex runtime wrapper for `rust-sqlite-cli-architecture`.

## Steps

1. Read `../../skills/rust-sqlite-cli-architecture/SKILL.md` and identify the exact task path, trigger, or command family that applies.
