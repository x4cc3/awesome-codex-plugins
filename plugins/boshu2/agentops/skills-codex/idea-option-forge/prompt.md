# Codex Execution Profile -- idea-option-forge

Codex runtime wrapper for `idea-option-forge`.

## Steps

1. Read `../../skills/idea-option-forge/SKILL.md` and identify the exact task path, trigger, or command family that applies.
