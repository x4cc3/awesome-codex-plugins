# Codex Execution Profile -- rust-crate-release-readiness

Codex runtime wrapper for `rust-crate-release-readiness`.

## Steps

1. Read `../../skills/rust-crate-release-readiness/SKILL.md` and identify the exact task path, trigger, or command family that applies.
