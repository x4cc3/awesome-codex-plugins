...
Codex-native entry point for the `rust-crate-release-readiness` operator skill.

The AgentOps source skill `../../skills/rust-crate-release-readiness/SKILL.md` is the source of truth
