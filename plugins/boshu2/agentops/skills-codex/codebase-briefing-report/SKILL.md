...
Codex-native entry point for the `codebase-briefing-report` operator skill.

The AgentOps source skill `../../skills/codebase-briefing-report/SKILL.md` is the source of truth
