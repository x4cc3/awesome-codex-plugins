# Codex Execution Profile -- codebase-briefing-report

Codex runtime wrapper for `codebase-briefing-report`.

## Steps

1. Read `../../skills/codebase-briefing-report/SKILL.md` and identify the exact task path, trigger, or command family that applies.
