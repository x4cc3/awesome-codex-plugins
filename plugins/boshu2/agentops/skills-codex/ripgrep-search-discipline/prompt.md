# Codex Execution Profile -- ripgrep-search-discipline

Codex runtime wrapper for `ripgrep-search-discipline`.

## Steps

1. Read `../../skills/ripgrep-search-discipline/SKILL.md` and identify the exact task path, trigger, or command family that applies.
