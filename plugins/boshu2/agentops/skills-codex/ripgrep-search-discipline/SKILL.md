...
Codex-native entry point for the `ripgrep-search-discipline` operator skill.

The AgentOps source skill `../../skills/ripgrep-search-discipline/SKILL.md` is the source of truth
