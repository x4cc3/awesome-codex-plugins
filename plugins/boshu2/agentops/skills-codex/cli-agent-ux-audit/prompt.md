# Codex Execution Profile -- cli-agent-ux-audit

Codex runtime wrapper for `cli-agent-ux-audit`.

## Steps

1. Read `../../skills/cli-agent-ux-audit/SKILL.md` and identify the exact task path, trigger, or command family that applies.
