# Codex Execution Profile -- ntm-review-worker-orchestration

Codex runtime wrapper for `ntm-review-worker-orchestration`.

## Steps

1. Read `../../skills/ntm-review-worker-orchestration/SKILL.md` and identify the exact task path, trigger, or command family that applies.
