...
Codex-native entry point for the `ntm-review-worker-orchestration` operator skill.

The AgentOps source skill `../../skills/ntm-review-worker-orchestration/SKILL.md` is the source of truth
