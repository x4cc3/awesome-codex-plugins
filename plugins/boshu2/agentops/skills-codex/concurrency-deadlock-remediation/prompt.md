# Codex Execution Profile -- concurrency-deadlock-remediation

Codex runtime wrapper for `concurrency-deadlock-remediation`.

## Steps

1. Read `../../skills/concurrency-deadlock-remediation/SKILL.md` and identify the exact task path, trigger, or command family that applies.
