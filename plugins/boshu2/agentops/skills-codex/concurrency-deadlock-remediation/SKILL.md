...
Codex-native entry point for the `concurrency-deadlock-remediation` operator skill.

The AgentOps source skill `../../skills/concurrency-deadlock-remediation/SKILL.md` is the source of truth
