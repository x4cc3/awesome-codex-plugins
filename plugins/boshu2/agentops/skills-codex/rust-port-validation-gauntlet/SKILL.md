...
Codex-native entry point for the `rust-port-validation-gauntlet` operator skill.

The AgentOps source skill `../../skills/rust-port-validation-gauntlet/SKILL.md` is the source of truth
