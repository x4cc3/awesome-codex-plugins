# Codex Execution Profile -- rust-port-validation-gauntlet

Codex runtime wrapper for `rust-port-validation-gauntlet`.

## Steps

1. Read `../../skills/rust-port-validation-gauntlet/SKILL.md` and identify the exact task path, trigger, or command family that applies.
