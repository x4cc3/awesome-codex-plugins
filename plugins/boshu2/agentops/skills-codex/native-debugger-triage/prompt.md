# Codex Execution Profile -- native-debugger-triage

Codex runtime wrapper for `native-debugger-triage`.

## Steps

1. Read `../../skills/native-debugger-triage/SKILL.md` and identify the exact task path, trigger, or command family that applies.
