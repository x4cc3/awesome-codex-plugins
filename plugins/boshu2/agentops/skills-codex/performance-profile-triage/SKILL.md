...
Codex-native entry point for the `performance-profile-triage` operator skill.

The AgentOps source skill `../../skills/performance-profile-triage/SKILL.md` is the source of truth
