# Codex Execution Profile -- performance-profile-triage

Codex runtime wrapper for `performance-profile-triage`.

## Steps

1. Read `../../skills/performance-profile-triage/SKILL.md` and identify the exact task path, trigger, or command family that applies.
