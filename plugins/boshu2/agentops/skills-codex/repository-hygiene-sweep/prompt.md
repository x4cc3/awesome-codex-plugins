# Codex Execution Profile -- repository-hygiene-sweep

Codex runtime wrapper for `repository-hygiene-sweep`.

## Steps

1. Read `../../skills/repository-hygiene-sweep/SKILL.md` and identify the exact task path, trigger, or command family that applies.
