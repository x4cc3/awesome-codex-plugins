# Codex Execution Profile -- project-reality-check

Codex runtime wrapper for `project-reality-check`.

## Steps

1. Read `../../skills/project-reality-check/SKILL.md` and identify the exact task path, trigger, or command family that applies.
