...
Codex-native entry point for the `project-reality-check` operator skill.

The AgentOps source skill `../../skills/project-reality-check/SKILL.md` is the source of truth
